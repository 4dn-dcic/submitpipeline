...
def add_repliseq_software():
    ...
    '''
    add_software_to_insert('4dn-dcic/docker-4dn-repliseq', 'v11', 'src/encoded/tests/data/inserts/software.json')
    add_software_to_insert('4dn-dcic/docker-4dn-repliseq', 'v11', 'src/encoded/tests/data/prod-inserts/software.json')
